...
def convert_old_cdot_format_to_new_format(df):
    ...
    # Order columns to match 2021+ format 
    column_order = [
        'CUID',
        'System Code', 
        'Rd_Number', 
